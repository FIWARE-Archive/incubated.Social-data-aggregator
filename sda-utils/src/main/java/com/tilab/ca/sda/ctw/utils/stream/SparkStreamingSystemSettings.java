 ...
 */
public class SparkStreamingSystemSettings {
    
     public static final String SPARK_DRIVER_PORT_PROPERTY="spark.driver.port";
     ...
     public static final String SPARK_WORKER_CLEANUP_ENABLED="spark.worker.cleanup.enabled";
}
